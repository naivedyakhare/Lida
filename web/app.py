...
print("\n\nI HAVE SET --COHERE-- HAS THE DEFAULT LLM SINCE IT IS FREE TO USE. To change the default LLM, change the variable 'default_llm' inside the app.py file in the 'lida/web' folder above line 19.")
print("To set COHERE_API_KEY create a .env file and write COHERE_API_KEY=<api_key> in the file in the same folder as app.py\n\n")
import os
print("//////////////////////////////////////")
print("//////////////////////////////////////")
